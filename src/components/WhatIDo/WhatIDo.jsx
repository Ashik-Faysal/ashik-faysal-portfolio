      ...
      <Zoom>
        <div className="grid md:grid-cols-2 gap-16">
          <div className="md:px-24">
            ...
            <button className="my-4 bg-gradient-to-r from-base-100 to-blue-500 hover:from-pink-500 hover:to-yellow-500 btn">
              See My Work
            </button>
          </div>
          <div>
            <div className="md:px-24">
              ...
              <p className="text-lg">
                ...
                project by using html , css , bootstrap , tailwind CSS , React
